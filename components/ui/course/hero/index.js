...
export default function Hero({title,description,image, skill, hasOwner}){
    return (
        <section>
              ...
              <div className="relative z-10 pb-8 bg-white sm:pb-16 md:pb-20 lg:max-w-2xl lg:w-full lg:pb-28 xl:pb-32">
                ...
                <main className="mt-10 mx-auto max-w-7xl px-4 sm:mt-12 sm:px-6 md:mt-16 lg:mt-20 lg:px-8 xl:mt-28">
                  <div className="sm:text-center lg:text-left">
                    {hasOwner &&
                      <div className="text-lg inline-block p-4 py-3 green rounded-full font-bold bg-green-300 text-green-700">
                        Você possui esse curso!
                      </div>
                    }
                    <h1 className="text-4xl py-5 tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
                    ...
                    <p className="mt-4 text-xl font-medium  text-indigo-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                      ...
                      <div className="mt-4 mb-6 py-5 mr-3 text-xl font-medium text-black-600 sm:mt-5 sm:text-lg sm:max-w-xl sm:mx-auto md:mt-5 md:text-xl lg:mx-0">
                        ...
                        <a className="green py-2 px-4 mr-5 rounded-full shadow-sm font-sm bg-indigo-300 text-purple-700">
                          {skill}
                        </a>
                      </div>
