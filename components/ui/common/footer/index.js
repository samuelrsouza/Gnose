...
export default function Footer(){
    ...
    <footer className="text-center mt-6 lg:text-left bg-gray-100 text-gray-600">
        <div className="flex justify-center items-center lg:justify-between p-6 border-b border-gray-300">
            ...
            <a href="https://twitter.com/samr_souza" className="mr-6 text-gray-600">
            ...
            <a href="https://www.instagram.com/sam.souzz/" className="mr-6 text-gray-600">
            ...
            <a href="https://www.linkedin.com/in/samuelrsouza/" className="mr-6 text-gray-600">
            ...
            <a href="https://github.com/samuelrsouza" className="text-gray-600">
